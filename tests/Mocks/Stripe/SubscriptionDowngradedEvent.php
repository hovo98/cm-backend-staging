...
class SubscriptionDowngradedEvent
{
    ...
    {
        return [
            "id" => "evt_1N7krRAyqeO9IwLwu1q33vKq",
            "object" => "event",
            ...
            "data" => [
                ...
                "previous_attributes" => [
                    "items" => [
                        "data" => [
                            [
                                ...
                                "plan" => [
                                    "id" => "price_1MtXjGAyqeO9IwLwvorESOb8",
                                    "object" => "plan",
                                    "active" => true,
                                    "aggregate_usage" => null,
                                    "amount" => 60000,
                                    "amount_decimal" => "60000",
                                    "billing_scheme" => "per_unit",
                                    "created" => 1680706470,
                                    "currency" => "usd",
                                    "interval" => "month",
                    ...
                    "latest_invoice" => "in_1N7kpCAyqeO9IwLwvgOZxzPi",
                    "plan" => [
                        "id" => "price_1MtXjGAyqeO9IwLwvorESOb8",
                        "amount" => 60000,
                        "amount_decimal" => "60000",
            ...
            "pending_webhooks" => 2,
            "request" => [
                "id" => "req_QxOxBBH129AS8d",
                "idempotency_key" => "7c4213dc-521b-4673-ac8e-e9c7d4da9215"
            ],
