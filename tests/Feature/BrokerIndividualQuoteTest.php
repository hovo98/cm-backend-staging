...
use App\Lender;
use App\Quote;
use App\Services\TypeServices\Broker\Quotes\Individual;
use Tests\TestCase;

class BrokerIndividualQuoteTest extends TestCase
{
    /**
    ...
    public function testInitialisation()
    {
        ...
        $serviceType = new Individual($deal->id, $lender->id);
        $queryService = new \App\Services\QueryServices\Broker\Quotes\Individual();
        $mapperService = new \App\Services\MapperServices\Broker\Quotes\Individual();
        $data = $serviceType->fmap($queryService, $mapperService);
