...
class BrokerAllQuotes extends TestCase
{
    /**
     * @test
     * @return void
     */
    public function get_all_broker_qoutes()
    {
        $termsheet = Termsheet::factory()->create([
            'id' => 1,
            'title' => 'Open',
        ]);
        ...
        $response = $this->graphQL(/** @lang GraphQL */ '
            query {
                ...
                input:  {sponsorNames: [], sponsorName: "", searchLocation: "", sortBy: {sort: GENERAL, by: DESC}}
                ){
                    data{
                        quote_id
                        lender_id
        ...
        ')
            ...
            ->assertJsonCount(1, 'data.brokerGetAllQuotes.data');
    }
}
